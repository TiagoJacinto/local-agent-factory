...
const DEFAULT_DB_RELATIVE = ".laf/sssf.db";
const MAX_LIMIT = 1000;
const DEFAULT_LIMIT = 500;

/**
 * Resolve the db path: --db arg wins, then SSSF_DB, then <cwd>/.laf/sssf.db.
...
export class SssfDb {
   ...
   * `.laf/sssf.db`), so deriving it as a sibling of the db file keeps
